...
ggplot(texas_legislature) +
  geom_line(aes(x=year, y=house_democrats), color="red", size=2) +
  geom_line(aes(x=year, y=house_republicans), color="blue", size=2) + 
  theme_bw() + 
...
ggplot(texas_legislature) +
  geom_line(aes(x=year, y=senate_democrats), color="red", size=2) +
  geom_line(aes(x=year, y=senate_republicans), color="blue", size=2) + 
  theme_bw() + 
